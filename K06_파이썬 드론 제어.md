...
## 5. 라즈베리파이에서 드론 비행을 제어 할 때   (aidrone Image 250309 버젼부터 적용됨)

<br/>

### <참고 : aidrone Image 250309 이전 버젼일 경우 직접 수정>
- **raspi-config 에서  Interface Options 설정에서  serial 이  No를 해야 한다.**
- **블루투스 서비스를 중단해야  serial을 사용할 수 있음**
    sudo  systemctl  stop hciuart
    sudo  systemctl  disable  hciuart
- **/boot/config.txt 파일 수정(맨마지막 줄에 추가)**
